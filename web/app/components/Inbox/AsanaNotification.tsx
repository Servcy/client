...
const AsanaNotification = ({ data, cause }: AsanaNotificationProps) => {
  ...
  const cleanImageLink = photo ? getCleanLink(photo.image_60x60 ?? photo.image_128x128 ?? photo.image_21x21 ?? "") : "";
        ...
        <>
          ...
          <div className="mb-2 mt-4 flex w-full">
            ...
            <div className="text-xs font-semibold text-servcy-black">
              <span className="border-1 mr-2 rounded-lg bg-servcy-white p-1">👍 {data.comment.likes.length}</span>
              <span className="border-1 mr-2 rounded-lg bg-servcy-white p-1">❤️ {data.comment.hearts.length}</span>
            </div>
          </div>
        </>
      );
      ...
      return (
        <>
          ...
          <div className="mb-2 mt-4 flex w-full">
            <div className="mr-2 w-[150px] font-mono font-semibold text-servcy-silver">Reactions:</div>
            <div className="text-xs font-semibold text-servcy-black">
              <span className="border-1 mr-2 rounded-lg bg-servcy-white p-1">👍 {data.task.likes.length}</span>
              <span className="border-1 mr-2 rounded-lg bg-servcy-white p-1">❤️ {data.task.hearts.length}</span>
            </div>
          </div>
          {data.task.assignee && (
            <div className="mb-2 flex w-full">
          ...
          {data.task.completed_at && data.task.completed && (
            <div className="mb-2 flex w-full">
              <div className="mr-2 w-[150px] font-mono font-semibold text-servcy-silver">Completed At:</div>
              <div>
