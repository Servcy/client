      ...
      {["FILE_UPDATE", "FILE_DELETE"].includes(data.event_type) ? null : data.event_type === "LIBRARY_PUBLISH" ? (
        <div className="min-h-[75px]">
          ...
          {data.created_components && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Components Were Created:</div>
          ...
          {data.modified_components && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Components Were Modified:</div>
              <ul className="text-sm">
          ...
          {data.created_styles && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Styles Were Created:</div>
              <ul className="text-sm">
          ...
          {data.deleted_components && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Components Were Deleted:</div>
              <ul className="text-sm">
          ...
          {data.deleted_styles && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Styles Were Deleted:</div>
              <ul className="text-sm">
          ...
          {data.modified_styles && (
            <div className="mb-4">
              <div className="text-xs font-semibold text-servcy-wheat">Following Styles Were Modified:</div>
              <ul className="text-sm">
