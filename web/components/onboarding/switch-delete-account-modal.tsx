                                ...
                                <div className="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div>
                                        <div className="flex items-center gap-x-4">
                                            ...
                                            <Dialog.Title
                                                as="h3"
                                                className="text-2xl font-medium leading-6 text-onboarding-text-100"
                                            >
                                        ...
                                        <div className="mt-6 px-4">
                                            <ul className="list-disc text-base font-normal text-onboarding-text-300">
                                                <li>
                                                    Delete this account if you have another and won{"'"}t use this
                                                    account.
                                                </li>
                                                <li>
                                                    Switch to another account if you{"'"}d like to come back to this
