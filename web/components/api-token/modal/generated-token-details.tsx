        ...
        <div>
            <div className="space-y-3">
                ...
                <p className="text-sm text-custom-text-400">
                    Copy and save this secret key in Servcy Pages. You can{"'"}t see this key after you hit Close. A CSV
                    file containing the key has been downloaded.
                </p>
            </div>
            <button
                type="button"
            ...
            <div className="mt-6 flex items-center justify-between">
                <p className="text-xs text-custom-text-400">
                    {tokenDetails.expired_at
                        ? `Expires ${renderFormattedDate(tokenDetails.expired_at)}`
                        : "Never expires"}
                </p>
