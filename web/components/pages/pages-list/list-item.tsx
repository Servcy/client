...
export const PagesListItem: FC<IPagesListItem> = observer(({ pageId, projectId }: IPagesListItem) => {
    ...
    const userCanEdit = isCurrentUserOwner || (currentProjectRole !== undefined && currentProjectRole >= ERoles.MEMBER)
    ...
    const userCanDelete = isCurrentUserOwner || (currentProjectRole !== undefined && currentProjectRole >= ERoles.ADMIN)
