          ...
          <div className="relative flex items-start justify-center">
            {primaryButton && (
              ...
              >
                ...
                <div
                  ...
                  className={`absolute bg-blue-300 ${comicBox?.direction === "left" ? "left-0 ml-2" : "right-0 mr-2"
                    } z-10 h-2.5 w-2.5 animate-ping rounded-full`}
                />
                <div
                  className={`absolute bg-blue-400/40 ${comicBox?.direction === "left" ? "left-0 ml-2.5" : "right-0 mr-2.5"
            ...
            {comicBox &&
              ...
              (comicBox.direction === "right" ? (
                <div
                  className={`absolute left-1/2 top-0 flex max-w-sm ${comicBox?.extraPadding ? "ml-[125px]" : "ml-[90px]"
                    } pb-5`}
                >
