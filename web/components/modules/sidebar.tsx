        ...
        updateModuleDetails(workspaceSlug.toString(), projectId.toString(), moduleId.toString(), data)
            .then((res) => {
                captureModuleEvent({
                    ...
                    payload: {
                        ...res,
                        changed_properties: Object.keys(data)[0],
        ...
        <>
            ...
            <>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <h4 className="w-full break-words text-xl font-semibold text-custom-text-100">
                        {moduleDetails.name}
                    </h4>
                </div>
                                                    ...
                                                    <>
                                                        ...
                                                        <LinksList
                                                            ...
                                                            userAuth={{
                                                                ...
                                                                isViewer: currentProjectRole === ERoles.MEMBER,
