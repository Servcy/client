                                    ...
                                    <div className="">
                                        <div className="flex items-start gap-x-4">
                                            ...
                                            <div>
                                                <Dialog.Title
                                                    as="h3"
                                                    className="my-4 text-2xl font-medium leading-6 text-custom-text-100"
                                                >
                                                    Deactivate your account?
                                                </Dialog.Title>
                                                <p className="mt-6 list-disc pr-4 text-base font-normal text-custom-text-200">
                                                    Once deactivated, you can{"'"}t be assigned issues and be billed for
                                                    your workspace.To reactivate your account, you will need an invite
                                                    to a workspace at this email address.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
