...
export const IssueFormRoot: FC<IssueFormProps> = observer((props) => {
    ...
    const { isCurrentWorkspaceSubscribed } = useBilling()
    ...
    const handleAutoGenerateDescription = async () => {
        if (!workspaceSlug || !projectId) return
        if (!isCurrentWorkspaceSubscribed) {
            onClose(false)
                                    ...
                                    <Fragment>
                                        <div className="absolute bottom-3.5 right-3.5 z-10 border-0.5 flex items-center gap-2">
                                            {issueName && issueName.trim() !== "" && (
                                                <button
                                                    type="button"
                                                    className={`flex items-center gap-y-1 gap-x-2 rounded px-1.5 py-1 text-xs bg-custom-background-80 ${
                                                ...
                                                >
                                                    {iAmFeelingLucky ? (
                                                        ...
                                                        <>
                                                            <Gem className="size-3 text-green-500" />I{"'"}m feeling
                                                            lucky
                                                        </>
                                                    ) : (
                                                        <>
                                            ...
                                            <GptAssistantPopover
                                                ...
                                                button={
                                                    <button
                                                        type="button"
                                                        className="flex items-center gap-y-1 gap-x-2 rounded px-1.5 py-1 text-xs hover:bg-custom-background-90"
                                                        onClick={() => {
                                                            if (!isCurrentWorkspaceSubscribed) {
                                                                onClose()
                                                                toggleUpgradePlanModal(true)
                                                    ...
                                                    >
                                                        {isCurrentWorkspaceSubscribed ? (
                                                            ...
                                                            <Gem className="size-3 text-green-500" />
                                                        )}
                                                        AI
                                                    </button>
                                                }
