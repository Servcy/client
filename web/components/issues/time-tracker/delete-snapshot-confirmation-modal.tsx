...
export const SnapshotDeleteModal: FC<Props> = (props) => {
    const { isOpen, setIsOpen, data, handleSnapshotOperations } = props
                                            ...
                                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    <p className="text-sm text-custom-text-200">
                                                        ...
                                                        ? This snapshot will be permanently removed. This action cannot
                                                        be undone.
                                                    </p>
                                                </div>
                                            </div>
