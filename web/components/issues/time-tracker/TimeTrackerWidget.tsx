...
export const TimeTrackerWidget: FC<ITimeTrackerWidget> = observer(({ setIsConfirmationModalOpen }) => (
    <Tooltip tooltipContent="Stop timer">
        <div
            className="servcy-card-wrapper z-10 absolute bottom-8 right-8 cursor-pointer h-12 w-12 bg-custom-primary-800 hover:scale-125 transition-transform duration-300 ease-in-out"
