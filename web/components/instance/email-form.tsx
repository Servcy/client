                    ...
                    <Controller
                        ...
                        render={({ field: { value, onChange, ref } }) => (
                            <Input
                                ...
                                placeholder="getitdone@projectservcy.com"
                                className="w-full rounded-md font-medium"
                            />
                        )}
                    />
                    ...
                    <Controller
                        ...
                        render={({ field: { value, onChange, ref } }) => (
                            <Input
                                ...
                                placeholder="no-reply@projectservcy.com"
                                className="w-full rounded-md font-medium"
                            />
                        )}
                    />
                    <p className="text-xs text-custom-text-400">
                        This is the email address your users will see when getting emails from this instance. You will
                        need to verify this address.
                    </p>
                </div>
            </div>
