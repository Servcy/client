...
export class InboxIssue implements IInboxIssue {
    ...
    fetchInboxIssues = async (
        ...
        try {
            ...
            const response = await this.inboxIssueService.fetchInboxIssues(
                workspaceSlug,
                projectId,
                inboxId,
                queryParams
    ...
    createInboxIssue = async (workspaceSlug: string, projectId: string, inboxId: string, data: Partial<TIssue>) => {
        try {
            ...
            runInAction(() => {
                ...
                set(this.inboxIssueMap, [inboxId, response.id], inboxIssue)
                update(
                    this.rootStore.inbox.inbox.inboxMap,
                    [inboxId, "pending_issue_count"],
    ...
    updateInboxIssue = async (
        ...
        try {
            const response = await this.inboxIssueService.updateInboxIssue(
                workspaceSlug,
                projectId,
                inboxId,
                inboxIssueId,
