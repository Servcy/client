...
export class IssueFiltersService extends APIService {
    ...
    async fetchProjectIssueFilters(workspaceSlug: string, projectId: string): Promise<IIssueFiltersResponse> {
        return this.get(`/project/workspace/${workspaceSlug}/projects/${projectId}/user-properties/`)
    ...
    async patchProjectIssueFilters(
        ...
        return this.patch(`/project/workspace/${workspaceSlug}/projects/${projectId}/user-properties/`, data)
            .then((response) => response?.data)
            .catch((error) => {
                throw error?.response?.data
            })
    ...
    async fetchCycleIssueFilters(
        ...
        return this.get(`/project/workspace/${workspaceSlug}/projects/${projectId}/cycles/${cycleId}/user-properties/`)
            .then((response) => response?.data)
            .catch((error) => {
                throw error?.response?.data
            })
    ...
    async patchCycleIssueFilters(
        ...
        return this.patch(
            `/project/workspace/${workspaceSlug}/projects/${projectId}/cycles/${cycleId}/user-properties/`,
            data
        )
            .then((response) => response?.data)
            .catch((error) => {
    ...
    async fetchModuleIssueFilters(
        ...
        return this.get(
            `/project/workspace/${workspaceSlug}/projects/${projectId}/modules/${moduleId}/user-properties/`
        )
            .then((response) => response?.data)
            .catch((error) => {
                throw error?.response?.data
