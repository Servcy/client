...
export class IssueFiltersService extends APIService {
    ...
    async fetchProjectIssueFilters(workspaceSlug: string, projectId: string): Promise<IIssueFiltersResponse> {
        return this.get(`/project/${workspaceSlug}/${projectId}/user-properties/`)
    ...
    async patchProjectIssueFilters(
        ...
        return this.patch(`/project/${workspaceSlug}/${projectId}/user-properties/`, data)
            .then((response) => response?.data)
            .catch((error) => {
                throw error?.response?.data
            })
    ...
    async fetchCycleIssueFilters(
        ...
        return this.get(`/project/${workspaceSlug}/${projectId}/cycles/${cycleId}/user-properties/`)
            .then((response) => response?.data)
            .catch((error) => {
                throw error?.response?.data
            })
