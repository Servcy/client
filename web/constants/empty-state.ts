...
export const WORKSPACE_EMPTY_STATE_DETAILS = {
    dashboard: {
        ...
        description:
            " Welcome to Servcy, we are excited to have you here. Create your first project and track your issues, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primaryButton: {
            text: "Build your first project",
        },
        comicBox: {
            title: "Everything starts with a project in Servcy",
...
export const WORKSPACE_SETTINGS_EMPTY_STATE_DETAILS = {
    "api-tokens": {
        ...
        description:
            "Servcy APIs can be used to integrate your data in Servcy with any external system. Create a token to get started.",
    },
    webhooks: {
        key: "webhooks",
...
export const EMPTY_ISSUE_STATE_DETAILS = {
    ...
    project: {
        ...
        comicBox: {
            title: "Issues are building blocks in Servcy.",
            description:
                "Redesign the Servcy UI, Rebrand the company, or Launch the new fuel injection system are examples of issues that likely have sub-issues.",
        },
        primaryButton: {
...
export const PAGE_EMPTY_STATE_DETAILS = {
    pages: {
        key: "pages",
        title: "Write a note, a doc, or a full knowledge base. Get Galileo, Servcy’s AI assistant, to help you get started",
        description:
            "Pages are thoughts potting space in Servcy. Take down meeting notes, format them easily, embed issues, lay them out using a library of components, and keep them all in your project’s context. To make short work of any doc, invoke Galileo, Servcy’s AI, with a shortcut or the click of a button.",
        primaryButton: {
