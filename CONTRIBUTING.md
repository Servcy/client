...
Before submitting a new issue, please search the [issues](https://github.com/Servcy/Client/issues) tab. Maybe an issue or discussion already exists and might inform you of workarounds. Otherwise, you can give new informplaneation.
